...
const data = {
  ...
  user_detail_89: {
    userImg: require("@assets/images/elements/okay.svg"),
    name: 'Zoila Legore',
    profession: 'Backend Dev',
    btn_1_text: 'Follow',
      title:"Рейтинг устойчивости",
      footer_text:"Подтвержденные рейтинги финансовой устойчивости страховщика (IFS) от международного агентства",
    btn_2_text: 'Message',
    ...
    card_detail: {
        userImg: require("@assets/images/elements/protect.webp"),
        title: "Перестраховочная защита",
        footer_text: "Дополнительная защита от немецкого перестраховочного общества General Reinsurance AG."
    },
    card_detail_2: {
        userImg: require("@assets/images/elements/protect.webp"),
        title: "Лицензии",
        footer_text: "Лицензия Нац. банка РК на осуществление страховой деятельности №2.2.51 от 28 мая 2019 года."
    },
  user_detail_58: {
...
mock.onGet("/api/card/1").reply(() => {
  return [200, data.card_detail];
});
mock.onGet("/api/card/2").reply(() => {
  return [200, data.card_detail_2];
});
